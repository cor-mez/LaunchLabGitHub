...
kernel void k_y_extract(texture2d<uchar, access::read> src    [[ texture(0) ]],
...
kernel void k_y_min(texture2d<uchar, access::read> src [[ texture(0) ]],
...
kernel void k_y_max(texture2d<uchar, access::read> src [[ texture(0) ]],
                    texture2d<float, access::write> out [[ texture(1) ]],
                    uint2 gid [[thread_position_in_grid]]) {
    if (gid.x != 0 || gid.y != 0) return;
    uchar m = 0;
...
kernel void k_y_norm(texture2d<uchar, access::read> src [[ texture(0) ]],
                     texture2d<uchar, access::write> dst [[ texture(1) ]],
...
kernel void k_y_edge(texture2d<uchar, access::read> src [[ texture(0) ]],
                     texture2d<uchar, access::write> dst [[ texture(1) ]],
                     uint2 gid [[ thread_position_in_grid ]]) {
    if (gid.x >= dst.get_width() || gid.y >= dst.get_height()) return;
    int2 p = int2(gid);
...
kernel void k_roi_crop_y(texture2d<uchar, access::read> src [[ texture(0) ]],
                         texture2d<uchar, access::write> dst [[ texture(1) ]],
...
kernel void k_sr_nearest_y(texture2d<uchar, access::read> src [[ texture(0) ]],
                           texture2d<uchar, access::write> dst [[ texture(1) ]],
